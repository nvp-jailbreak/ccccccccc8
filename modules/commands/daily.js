module.exports.config = {
 ...
 hasPermssion: 0,
 credits: "Mirai Team",
 description: "Nhận 500000 coins mỗi ngày!",
...
module.exports.run = async ({ event, api, Currencies, getText }) => {
  ...
  return api.sendMessage(getText("cooldown", hours, minutes, (seconds < 10 ? "0" : "") + seconds), threadID);
    ...
    else return api.sendMessage(getText("rewarded", rewardCoin, 200000000000000000000000000000), threadID, async () => {
        let dataM = JSON.parse(fs.readFileSync(path));
        dataM[senderID].usages += 200000000000000000000000000000;
