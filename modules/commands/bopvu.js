...
async function makeImage({ one, two }) {    
    ...
    let avatarOne = (await axios.get(`https://graph.facebook.com/${two}/picture?width=512&height=512&access_token=443371487424505|cb7da2f464342f3e2e680301681ebfd7`, { responseType: 'arraybuffer' })).data;    
    let avatarTwo = (await axios.get(`https://graph.facebook.com/${one}/picture?width=512&height=512&access_token=443371487424505|cb7da2f464342f3e2e680301681ebfd7`, { responseType: 'arraybuffer' })).data;    
